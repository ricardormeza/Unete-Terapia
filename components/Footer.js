        ...
        <footer className="bg-[#BF1B75] text-white body-font">
            ...
            <div className="bg-pink-300">
                <div className="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row ">
                    ...
                    <Link href="https://www.facebook.com/UneteDesarrolloIntegral" className="text-gray-500 hover:text-pink-800">
                    ...
                    <Link href="https://www.instagram.com/unetedesarrollointegral/" className="ml-3 text-gray-500 hover:text-pink-800">
