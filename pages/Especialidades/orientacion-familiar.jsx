                    ...
                    <div className="rounded-lg h-64 overflow-hidden">
                        ...
                        <div className="container ">
                            <div>
                                ...
                                <p className='text-base font-DMSans text-justify'>La orientación familiar es un enfoque terapéutico que dirige una dinámica familiar buscando identificar patrones de comportamiento, así como ayudar a las familias a resolver problemas y mejorar sus relaciones. Se basa en una variedad de teorías psicológicas, incluyendo la de sistemas, la del apego y la del ciclo de vida familiar.</p>
                        ...
                        <div className="container py-5">
                            ...
                            <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
                                ...
                                <div className="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
                                    ...
                                    <p className="mb-8 text-2xl leading-relaxed">Mejora la comunicación, la comprensión de manera efectiva de aquellos a quien más quieres, en Unete te ayudamos, agenda tu cita en el link de abajo.</p>
